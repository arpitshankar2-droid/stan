...
export default async function Home() {
  ...
  return (
    <main className="relative flex flex-1 flex-col items-center overflow-hidden px-6 pt-16 pb-24">
      <div
        aria-hidden
      ...
      <div className="flex w-full flex-col items-center">
        <h1 className="font-display text-[clamp(4rem,18vw,11rem)] leading-none text-arena-gradient text-glow-violet">
          Stan
        </h1>
